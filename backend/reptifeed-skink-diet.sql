...
INSERT INTO foods (name, type, frequency, image, treat, tips)
VALUES 
-- Proteins
      -- Often
      ...
      -- Treats
       ...
       ('eggs', 'protein', 'occasionally', '', TRUE, "Can be eaten raw or boiled. Skinks do eat eggshells in the wild but grind them up because they can scratch your skink's digestive system"),
